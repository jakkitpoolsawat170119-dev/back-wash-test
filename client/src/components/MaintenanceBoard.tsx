...
const MaintenanceBoard: React.FC<{ operatorName: string | null }> = ({ operatorName }) => {
  ...
  /* ย้ายเจ้าของงานรูทีน "ถาวร" — คนละเรื่องกับ doBypass(...handoffTo) ที่มอบต่อเฉพาะวันนั้น
     ...
     แต่ "รอบความถี่" ตามไปด้วย — dueRoutines ฝั่งเซิร์ฟเวอร์ถอยไปดูประวัติของ *ตัวงาน*
     ถ้าเจ้าของใหม่ยังไม่เคยติ๊ก (ไม่งั้นงานรายเดือนจะเด้ง "ถึงคิว" ทันทีที่ย้าย) */
            ...
            <div style={{
              ...
              {others.length > 0 && <>
                ...
                <div style={{ fontSize: 10.5, color: '#a89e94', padding: '2px 8px 4px', lineHeight: 1.5 }}>
                  ...
                  <br />รอบความถี่ไม่รีเซ็ต — งานรายเดือนที่เพิ่งทำ จะไม่เด้งขึ้นใหม่ทันที
                </div>
              </>}
            </div>
          )}
